...
/* harmony import */ var _modules_form_submit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/form submit */ "./src/js/modules/form submit.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_form_submit__WEBPACK_IMPORTED_MODULE_1__["default"])();
});

/***/ }),

/***/ "./src/js/modules/form submit.js":
/*!***************************************!*\
  !*** ./src/js/modules/form submit.js ***!
  \***************************************/
...
var forms = function forms() {
  function submit() {
    ...
    var dataBase = []; //constants

    var modal = document.querySelector('.modal__add'),
        modalSubmit = document.querySelector('.modal__submit'),
        elementModalSubmit = _toConsumableArray(modalSubmit.elements).filter(function (elem) {
      return elem.tagName !== 'BUTTON' && elem.type !== 'submit';
    }),
        modalBtnSubmit = document.querySelector('.modal__btn-submit'),
        modalBtnWarning = document.querySelector('.modal__btn-warning'); //check if all data has been entered


    modalSubmit.addEventListener('input', function () {
      var validForm = elementModalSubmit.every(function (elem) {
        return elem.value;
      });
    ...
    modalSubmit.addEventListener('submit', function (event) {
      ...
      var _iterator = _createForOfIteratorHelper(elementModalSubmit),
          _step;
      ...
      dataBase.push(itemObj); //console.log(dataBase);
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, modalClose) {
    ...
    close = modalClose,
        modalBtnSubmit = document.querySelector('.modal__btn-submit'),
        modalSubmit = document.querySelector('.modal__submit'); //open modals
