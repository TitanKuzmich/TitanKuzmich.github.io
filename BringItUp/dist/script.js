...
/* harmony import */ var _modules_show_info__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/show-info */ "./src/js/modules/show-info.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_show_info__WEBPACK_IMPORTED_MODULE_6__["default"]('.plus__content').init();
    ...
    value: function bindTriggers(container, items, counter) {
      container.querySelector('.plus').addEventListener('click', function () {
        if (counter !== items.length - 2) {
          ...
          setTimeout(function () {
            items[items.length - 1].classList.remove('slideInDown');
          }, 800);
          counter++;
        } else {
          items[counter].style.display = 'flex';
  ...
  _createClass(ShowInfo, [{
    ...
    value: function init() {
      this.btns.forEach(function (btn) {
        ...
        btn.addEventListener('click', function () {
          var sibling = btn.closest('.module__info-show').previousElementSibling;
          i++;
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        slide.classList.remove(_this2.activeClass, 'fadeIn');
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        _this3.slides[0].classList.add('fadeIn');
      });
    }
  }, {
    key: "autoPlay",
    ...
    value: function pauseOnMouseEnter() {
      var _this5 = this;
