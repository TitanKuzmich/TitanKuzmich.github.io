...
/* harmony import */ var _modules_flipCard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/flipCard */ "./src/js/modules/flipCard.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_parallax__WEBPACK_IMPORTED_MODULE_0__["default"])('.subheader', '.subheader-particles');
  Object(_modules_flipCard__WEBPACK_IMPORTED_MODULE_1__["default"])('.frontside', '.backside');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["default"])('.carousel');
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_3__["default"])('.pageup');
...
/* harmony default export */ __webpack_exports__["default"] = (bureger);
...
var flipCard = function flipCard(front, back) {
  var flipForward = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.more';
  var flipBack = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '.back';
  var frontSide = document.querySelectorAll(front),
  ...
  backBtn.forEach(function (item, i) {
    item.addEventListener('click', function () {
...
var parallax = function parallax(relative, particles) {
  var rel = document.querySelector(relative);
  var part = document.querySelectorAll(particles);
  ...
  function moveParticles(e) {
    part.forEach(function (layer) {
      ...
      layer.style.transform = "translateX(".concat(x, "px) translateY(").concat(y, "px)");
    });
  }
...
var slider = function slider(sliderContainer) {
  var slider = document.querySelectorAll(sliderContainer);

  var _loop = function _loop(i) {
    var width = window.getComputedStyle(slider[i].querySelector('.carousel-inner')).width;
    var slides = slider[i].querySelectorAll('.carousel-item');
    var slidesField = slider[i].querySelector('.carousel-slides');
    var dots = slider[i].querySelectorAll('.carousel-indicators li');
    var next = slider[i].querySelector('[data-slide="next"]');
    var prev = slider[i].querySelector('[data-slide="prev"]');
    var indicators = slider[i].querySelectorAll(".carousel-indicators li");
